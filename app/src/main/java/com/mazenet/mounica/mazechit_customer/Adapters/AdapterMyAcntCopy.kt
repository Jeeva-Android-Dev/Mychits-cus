package com.mazenet.mounica.mazechit_customer.Adapters
...
import com.mazenet.mounica.mazechit_customer.Model.AccountCopyData
...
class AdapterMyAcntCopy(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {
        val view = LayoutInflater.from(parent.context)
            .inflate(com.mazenet.mounica.mazechit_customer.R.layout.myacntcopy_listitem, parent, false)
    ...
    class MyViewHolder(itemView: View, listener: IAdapterClickListener) : RecyclerView.ViewHolder(itemView),
        ...
        init {
            ...
            txt_chitvalue = itemView.findViewById(com.mazenet.mounica.mazechit_customer.R.id.txt_chitvalue)
            txt_groupname =
                itemView.findViewById(com.mazenet.mounica.mazechit_customer.R.id.txt_groupname) as TextView
            txt_paid = itemView.findViewById(com.mazenet.mounica.mazechit_customer.R.id.txt_paid) as TextView
            txt_pending = itemView.findViewById(com.mazenet.mounica.mazechit_customer.R.id.txt_pending) as TextView
            txt_months = itemView.findViewById(com.mazenet.mounica.mazechit_customer.R.id.txt_months) as TextView
            txt_stattus = itemView.findViewById(com.mazenet.mounica.mazechit_customer.R.id.txt_stattus) as TextView
