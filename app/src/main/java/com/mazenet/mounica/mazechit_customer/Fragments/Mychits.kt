...
import com.mazenet.mounica.mazechit_customer.Adapters.IAdapterClickListener
import com.mazenet.mounica.mazechit_customer.Model.MyChitsModel
...
import com.mazenet.mounica.mazechit_customer.Activities.HomeActivity
import mychitscom.mazenet.prabakaran.mazechit_customer.Adapters.AdapterMyChits
...
class Mychits : BaseFragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(com.mazenet.mounica.mazechit_customer.R.layout.fragment_mychits, container, false)
        (activity as HomeActivity).setActionBarTitle("My Chits")
//        (activity as HomeActivity).setActionBarColor(R.color.red_dash)
        Recycler_groups = view.findViewById(com.mazenet.mounica.mazechit_customer.R.id.reecycler_mychits) as RecyclerView
        pb_mychit = view.findViewById(com.mazenet.mounica.mazechit_customer.R.id.pb_mychits) as ProgressBar
        swiper_mychits = view.findViewById(com.mazenet.mounica.mazechit_customer.R.id.swiper_mychits) as SwipeRefreshLayout
